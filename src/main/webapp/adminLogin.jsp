...
<div class = "container">
    ...
    <div class = "main">
        <div class = "mainbody">
            <section class = "maincon">
                <%-- 供选择登录方式   --%>
                <div class = "tabHead">
                    <span id="pwdLoginSpan" class="active selected_underline" style="width: 50%;"><a id="userNameLogin_a" href="https://ca.csu.edu.cn/authserver/login?type=userNameLogin&amp;service=http%3A%2F%2Fmy.csu.edu.cn%2Flogin%2Findex.jsp" class="loginFont_a">账号登录</a></span>
                ...
                <div class="login-pc">
                    ...
                    <div id="pwdLoginDiv" style="">
                        <div>
                            ...
                            <form class="loginFromClass" method="post" id="pwdFromId" action="${pageContext.request.contextPath}/LoginAdminServlet">
                                <div class="form">
                                    <!-- 用户名密码登录 -->
                                    <div class="m-account">
                                        <div class="username item">
                                            <span class="prex-icon"><img src="images/user1.png" class="login-icon"></span>
                                            <input id="adminid" name="adminid" type="text" placeholder="请输入管理员账号" title="请输入管理员账号" value=""></div>
                                        <div class="password item">
                                            <span class="prex-icon"><img src="images/pass1.png" class="login-icon"></span>
                                            <input id="password" name="password" type="password" placeholder="请输入管理员账号" title="请输入管理员账号"><input id="saltPassword" name="password" type="hidden"><!-- <a class="input_eye suffix-icon eyehide"></a> --></div>
    ...
    <div class = "adminLogin">
        <a href="${pageContext.request.contextPath}/index.jsp">普通用户登录</a>
