function checktelcaptcha(){
     ...
     */
    xmlhttp.open("GET","getDynamicCode?usertel="+usertel+"&&captcha="+captcha,true);
...
window.addEventListener("load",function (){
    ...
    getCodeText.addEventListener("click",checktelcaptcha);

    var captchaImg = document.querySelector("#captcha-img");
    captchaImg.addEventListener("click",freshVCode);
